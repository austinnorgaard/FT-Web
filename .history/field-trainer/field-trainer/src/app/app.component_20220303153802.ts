...
export class AppComponent {
    ...
    getLoc(id: string){
        ...
        element.style.width = `width: ${rect.width}`;
        element.style.height = `height: ${rect.height}`;
        element.style.position = `x: ${rect.x}, y: ${rect.y}`;
        element.style.top = `top: ${rect.top}`;
        element.style.bottom = `bottom: ${rect.bottom}`;
        return element;
    }
}
