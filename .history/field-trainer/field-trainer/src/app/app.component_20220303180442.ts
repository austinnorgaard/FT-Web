...
export class AppComponent {
    ...
    getImage() {
        ...
        if (field === 'football')
        {
            return '1200px-AmFBfield.svg.png';
        }
        else if (field === 'soccer')
        {
            return 'Soccer_field_-_empty.svg.png';
        }
        else if (field === 'basketball')
        {
            return 'istockphoto-1212609648-612x612.jpg';
        }
        else if (field === 'track')
        {
            return 'cartoon-running-track-stadium-vector-17932997.jpg';
        }
    }
}
