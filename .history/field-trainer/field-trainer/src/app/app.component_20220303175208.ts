...
export class AppComponent {
    ...
    getImage() {
        ...
        if (field === 'football')
        {
            document.getElementsByName('field')[0].src = '1200px-AmFBfield.svg.png';
        }
        else if (field === 'soccer')
        {
            document.getElementById('field').src = 'Soccer_field_-_empty.svg.png';
        }
        else if (field === 'basketball')
        {
            document.getElementById('field').src = 'istockphoto-1212609648-612x612.jpg';
        }
        else if (field === 'track')
        {
            document.getElementById('field').src = 'cartoon-running-track-stadium-vector-17932997.jpg';
        }
    }
}
