...
export class UserRegistrationModel extends UserRegistration {
    ...
    isValid(): Boolean {
        ...
        if (this.user.address1 === "") return false;
        if (this.user.address2 === "") return false;
        if (this.user.city === "") return false;
        if (this.user.state === "") return false;
        if (this.user.zipCode === "") return false;
        if (this.user.country === "") return false;
        if (this.user.phoneNumber === "") return false;
