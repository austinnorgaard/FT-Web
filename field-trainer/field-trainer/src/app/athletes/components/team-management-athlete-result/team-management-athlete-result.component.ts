...
@Component({
    selector: "ft-team-management-athlete-result",
    templateUrl: "./team-management-athlete-result.component.html",
    styleUrls: ["./team-management-athlete-result.component.css"],
})
export class TeamManagementAthleteResultComponent implements OnInit {
